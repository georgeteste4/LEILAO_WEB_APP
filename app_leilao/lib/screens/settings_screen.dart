  ...
  Future checkAppUpdate() async {
    ...
    if (info == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Você já está na versão mais recente (v1.0.6)!')),
      );
    }
  }
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: const Text('v1.0.6', style: TextStyle(color: AppColors.brandLight, fontFamily: 'JetBrains Mono', fontSize: 11, fontWeight: FontWeight.bold)),
                    ),
                  ],
                ),
